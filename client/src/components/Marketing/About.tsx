...
const About: FC = () => {
  ...
  const title = safeT(t as any, 'pages.about.title', 'Über uns');
  const description = safeT(
    t as any,
    'pages.about.description',
    'Lerne SIGMACODE AI kennen – Mission, Werte und Team.',
  );
    ...
    <>
      ...
      >
        ...
        <section className="space-y-4 text-gray-300">
          <p>Wir bauen produktreife KI erlebbar: sicher, auditierbar, skalierbar.</p>
          <p>
            Unser Fokus: Agenten & MAS, die echte Workflows automatisieren – messbar und steuerbar.
          </p>
        </section>
      </main>
      <FooterSection />
