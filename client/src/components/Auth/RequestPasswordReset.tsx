...
const ResetPasswordBodyText = () => {
  ...
  return (
    <div className="flex flex-col space-y-4">
      <p>{t('com_auth_reset_password_if_email_exists')}</p>
      <a
    ...
    requestPasswordReset.mutate(data, {
      onSuccess: (data: TRequestPasswordResetResponse) => {
        if (data.link && !startupConfig?.emailEnabled) {
          setHeaderText(t('com_auth_reset_password'));
          setBodyText(
            <span>
              {t('com_auth_click')}{' '}
              ...
              {t('com_auth_to_reset_your_password')}
            </span>,
          );
        } else {
          setHeaderText(t('com_auth_reset_password_link_sent'));
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          <input
            ...
            {...register('email', {
              ...
              minLength: {
                value: 3,
                message: t('com_auth_email_min_length'),
              },
              maxLength: {
                value: 120,
                message: t('com_auth_email_max_length'),
              },
              pattern: {
                value: /\S+@\S+\.\S+/,
      ...
      <div className="space-y-4">
        ...
        >
          {isLoading ? <Spinner /> : t('com_auth_continue')}
        </Button>
        <a
          href="/login"
