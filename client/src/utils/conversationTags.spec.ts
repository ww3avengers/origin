...
type TConversationTagsResponse = TConversationTag[];
  ...
  describe('updateConversationTag', () => {
    it('updates the first tag correctly', () => {
      const updated = updateConversationTag(
        ...
        { ...conversations[3], tag: 'tag3-new', description: 'description3-new' },
        'tag3',
      );
