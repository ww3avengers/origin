...
import { useCustomLink, useAuthContext } from '~/hooks';
        ...
        <BreadcrumbList>
          <BreadcrumbItem className="hover:dark:text-white">
            ...
            >
              ...
              <span className="hidden md:flex">{t('com_ui_back_to_chat')}</span>
              <span className="flex md:hidden">{t('com_ui_chat')}</span>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          {/*
